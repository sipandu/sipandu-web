...
@section('title', 'Detail Verifikasi Lansia')
            ...
            <div class="col-12">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <img src="{{ route('Get KK', $user->id_kk ) }}" class="card-img-bottom" alt="File KK Lansia">
                            </div>
                            <div class="col-12 mt-3">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="namaLansia" value="{{$user->lansia->nama_lansia}}" disabled>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="lokasiPosyandu" value="{{$user->lansia->posyandu->nama_posyandu}}" disabled>
                                            <label for="lokasiPosyandu">Lokasi Posyandu</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="banjar" value="{{$user->lansia->posyandu->banjar}}" disabled>
