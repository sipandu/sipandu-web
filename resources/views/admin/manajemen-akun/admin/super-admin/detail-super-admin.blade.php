                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Super Admin', $superAdmin->id) }}" method="POST" class="needs-validation form-horizontal my-auto" novalidate>
                                    @csrf
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="floatingInput" value="{{ old('nama', $superAdmin->nama_super_admin) }}" placeholder="Nama Administrator" required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" id="floatingInput" value="{{ old('nik', $superAdmin->nik) }}" placeholder="NIK Administrator" required>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" id="floatingInput" value="{{ old('tempat_lahir', $superAdmin->tempat_lahir) }}" placeholder="Tempat Lahir Administrator" required>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input  type="text" name="tgl_lahir" autocomplete="off" class="form-control @error('tgl_lahir') is-invalid @enderror" value="{{ old( date('d-m-YY', strtotime('tgl_lahir')), date('d-m-YY', strtotime($superAdmin->tanggal_lahir))) }}" id="floatingInput" placeholder="Tanggal Lahir Administrator" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask required>
