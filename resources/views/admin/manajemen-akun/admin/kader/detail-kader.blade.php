                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="profile">
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get KTP Kader', $pegawai->id ) }}" class="card-img-buttom" alt="...">
                                </div>
                            </div>
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Kader', $pegawai->id) }}" method="POST" class="needs-validation form-horizontal my-auto" novalidate>
                                    @csrf
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="floatingInput" value="{{ old('nama', $pegawai->nama_pegawai) }}" placeholder="Nama Kader" required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" id="floatingInput" value="{{ old('nik', $pegawai->nik) }}" placeholder="NIK Kader" required>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" id="floatingInput" value="{{ old('tempat_lahir', $pegawai->tempat_lahir) }}" placeholder="Tempat Lahir Kader" required>
