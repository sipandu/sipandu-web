                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="bs-stepper py-3">
                            ...
                            <form action="{{ route('Simpan Admin') }}" enctype="multipart/form-data" method="post" class="needs-validation my-auto" novalidate>
                                @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="name" id="name" autocomplete="off" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}"  placeholder="Nama lengkap" required>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror" value="{{ old('gender') }}" required aria-placeholder="Pilih jenis kelamin ...">
                                                            @if (old('gender'))
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 px-0">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label @error('file') is-invalid @enderror" style="overflow-y: hidden" for="fileKTP">Unggah scan KTP</label>
                                                            @error('file')
                                                                <div class="invalid-feedback text-start">
                                                                    {{ $message }}
                                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <select name="lokasi_posyandu" id="lokasi_posyandu" class="form-control select2 @error('lokasi_posyandu') is-invalid @enderror" value="{{ old('lokasi_posyandu') }}" style="width: 100%" aria-placeholder="Pilih lokasi posyandu ...">
