                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Profile Nakes', $nakes->id) }}" method="POST" class="needs-validation form-horizontal my-auto" novalidate>
                                    @csrf
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="floatingInput" value="{{ old('nama', $nakes->nama_nakes) }}" placeholder="Nama Kader" required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" id="floatingInput" value="{{ old('nik', $nakes->nik) }}" placeholder="NIK Kader" required>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" id="floatingInput" value="{{ old('tempat_lahir', $nakes->tempat_lahir) }}" placeholder="Tempat Lahir Kader" required>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input  type="text" name="tgl_lahir" autocomplete="off" class="form-control @error('tgl_lahir') is-invalid @enderror" value="{{ old('tgl_lahir', date('d-m-Y', strtotime($nakes->tanggal_lahir))) }}" id="floatingInput" placeholder="Tanggal Lahir Kader" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask required>
