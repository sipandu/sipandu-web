        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Nakes') }}">Semua Nakes</a></li>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="bs-stepper py-3">
                            ...
                            <form action="{{ route('Simpan Nakes') }}" enctype="multipart/form-data" method="post" class="needs-validation my-auto" novalidate>
                                @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror" required data-placeholder="Test" data-placeholder="Test 2">
                                                            @if ( old('gender') )
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 px-0">
                                                        <div class="custom-file">
                                                            <input type="file" name="file" autocomplete="off" class="custom-file-input @error('file') is-invalid @enderror" id="fileKTP" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="select2" multiple="multiple" data-placeholder="Pilih posyandu tempat bertugas" name="lokasi_posyandu[]" style="width: 100%;" required>
