        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Head Admin') }}">Semua Head Admin</a></li>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="bs-stepper py-3">
                            ...
                            <form action="{{ route('Simpan Head Admin') }}" enctype="multipart/form-data" method="post" class="needs-validation my-auto" novalidate>
                                @csrf
