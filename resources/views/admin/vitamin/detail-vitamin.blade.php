        ...
        <div class="col-auto ml-auto my-auto text-right mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Semua Jenis Vitamin') }}">Semua Jenis Vitamin</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline card-primary p-3">
                    <form action="{{ route('Update Vitamin', $vitamin->id) }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-sm-12 col-md-6 my-2">
                                <label for="nama_vitamin">Nama Vitamin<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" autocomplete="off" class="form-control @error('nama_vitamin') is-invalid @enderror" id="nama_vitamin" name="nama_vitamin" value="{{ old('nama_vitamin', $vitamin->nama_vitamin) }}" placeholder="Nama Vitamin" required>
                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off" class="form-control @error('usia_pemberian') is-invalid @enderror" id="usia_pemberian" name="usia_pemberian" value="{{ old('usia_pemberian', $vitamin->usia_pemberian) }}" placeholder="Usia pemberian" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off" class="form-control @error('perulangan') is-invalid @enderror" id="perulangan" name="perulangan" value="{{ old('perulangan', $vitamin->perulangan) }}" placeholder="Frekuensi perulangan" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select name="status" class="form-control @error('status') is-invalid @enderror" id="status" aria-placeholder="Pilih status vitamin" required>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select name="penerima" class="form-control @error('penerima') is-invalid @enderror" id="penerima" aria-placeholder="Pilih penerima vitamin" required>                                                
                            ...
                            <div class="col-12 my-2">
                                <div class="form-floating">
                                    <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" placeholder="Masukan keterangan tambahan" style="height: 120px" required autocomplete="off">{{ old('keterangan', $vitamin->deskripsi) }}</textarea>
