            ...
            <div class="col-md-5">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <h3 class="profile-username text-center">{{Auth::user()->ibu->nama_ibu_hamil}}</h3>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="personal">
                                <form action="#" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputNIK" class="col-sm-2 col-form-label">Nama Suami</label>
                                        <div class="col-sm-10 my-auto">
                            ...
                            <div class="tab-pane" id="jabatan">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 my-auto">
                                        <input type="email" class="form-control" id="inputName" placeholder="Tempat Tugas" disabled readonly value="{{Auth::user()->ibu->posyandu->nama_posyandu}}" >
                                    </div>
                                </div>
                                {{-- <div class="form-group row">
