            ...
            <div class="col-md-5">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <h3 class="profile-username text-center">{{Auth::user()->anak->nama_anak}}</h3>
                        <p class="text-muted text-center">Anak {{Auth::user()->anak->jenis_kelamin}}</p>
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#jabatan" data-toggle="tab">Riwayat Kesehatan</a></li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="jabatan">
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-2 col-form-label">Tempat Posyandu</label>
                                    <div class="col-sm-10 my-auto">
                                        <input type="email" class="form-control" id="inputName" placeholder="Tempat Tugas" disabled readonly value="{{Auth::user()->anak->posyandu->nama_posyandu}}" >
                                    </div>
                                </div>
                                {{-- <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 my-auto">
                                    <input type="text" class="form-control" id="inputName2" placeholder="Terdaftar Sejak" disabled readonly value="{{ date('d-M-yy', strtotime(Auth::user()->created_at)) }}">
                                    </div>
                                </div>
                            </div>
