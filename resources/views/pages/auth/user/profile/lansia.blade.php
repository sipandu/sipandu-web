            ...
            <div class="col-md-5">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <h3 class="profile-username text-center">{{Auth::user()->lansia->nama_lansia}}</h3>
                        <p class="text-muted text-center">Lansia {{Auth::user()->lansia->jenis_kelamin}}</p>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="jabatan">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 my-auto">
                                        <input type="email" class="form-control" id="inputName" placeholder="Tempat Tugas" disabled readonly value="{{Auth::user()->lansia->posyandu->nama_posyandu}}" >
                                    </div>
                                </div>
                                {{-- <div class="form-group row">
