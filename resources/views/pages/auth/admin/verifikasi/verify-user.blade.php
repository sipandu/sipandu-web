              ...
              <div class="card card-primary card-outline tab-content" id="v-pills-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    <div class="card-body p-0">
                      ...
                      @else
                        <p class="my-3 text-center fs-5 fw-bold">Tidak Terdapat Akun Ibu Hamil untuk Diverifikasi</p>
                      @endif
                    </div>
                  </div>
                  <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    <div class="card-body p-0">
                      ...
                      @else
                        <p class="my-3 text-center fs-5 fw-bold">Tidak Terdapat Akun Anak untuk Diverifikasi</p>
                      @endif
                    </div>
                  </div>
                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                  <div class="card-body p-0">
                    ...
                    @else
                      <p class="my-3 text-center fs-5 fw-bold">Tidak Terdapat Akun Lansia untuk Diverifikasi</p>
                    @endif
                  </div>
                </div>
              </div>
...
@push('js')
  ...
  <script>
      $(document).ready(function(){
        ...
        $('#konfirmasi-anggota').addClass('active');
      });
