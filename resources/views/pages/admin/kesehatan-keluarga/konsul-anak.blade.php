                                    ...
                                    <div class="collapse my-3" id="konsulAnak">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 my-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" autocomplete="off" class="form-control" id="lingkar_kepala" value="{{ old('lingkar_kepala') }}" placeholder="LP Anak" disabled>
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6 my-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" autocomplete="off" class="form-control" id="berat_badan" value="{{ old('berat_badan') }}" placeholder="Berat Anak" disabled>
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6 my-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" autocomplete="off" class="form-control" id="tinggi_badan" value="{{ old('tinggi_badan') }}" placeholder="Tinggi Anak" disabled>
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
