                    ...
                    @foreach ($command as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                @php
                                    $child = $item->getMenuChild();
                                @endphp
                                @if($child->count() > 0)
                                    <a href="{{ route('pertanyaan-satu-arah.child.home', $item->id) }}" title="lihat child command" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>
                                @endif
                                <a href="{{ route('pertanyaan-satu-arah.edit', $item->id) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                            </td>
                        </tr>
                    @endforeach
                  </tbody>
