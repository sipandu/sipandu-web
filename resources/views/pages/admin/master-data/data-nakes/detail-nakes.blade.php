        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Nakes') }}">Data Kader</a></li>
            ...
            <div class="col-md-5">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <h3 class="profile-username text-center">{{$dataAdmin->nakes->nama_nakes}}</h3>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="profile">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" value="{{ $dataAdmin->nakes->nama_nakes}}" disabled readonly>
                                    <label for="floatingInput">Nama Lengkap</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" value="{{ $dataAdmin->nakes->nik}}" disabled readonly>
                                    <label for="floatingInput">Nomor Induk Kependudukan</label>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" value="{{ $dataAdmin->nakes->tempat_lahir}}" disabled readonly>
                                            <label for="floatingInput">Tempat Lahir</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" value="{{ old('email', date('d-M-Y', strtotime($dataAdmin->nakes->tanggal_lahir))) }}" disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            @if ($dataAdmin->nakes->nomor_telepon == NULL)
                                                <input type="text" class="form-control" id="floatingInput" value="Nomor telepon belum dimasukan" disabled readonly>
                                            @else
                                                <input type="text" class="form-control" id="floatingInput" value="{{ $dataAdmin->nakes->nomor_telepon}}" disabled readonly>
                                            @endif
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            @if ($dataAdmin->nakes->username_telegram == NULL)
                                                <input type="text" class="form-control" id="floatingInput" value="Username Telegram belum dimasukan" disabled readonly>
                                            @else
                                                <input type="text" class="form-control" id="floatingInput" value="{{ $dataAdmin->nakes->username_telegram }}" disabled readonly>
                                            @endif
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get Image Data Nakes KTP', $dataAdmin->nakes->id ) }}" class="card-img-buttom" alt="...">
                                </div>
                            </div>
                            @if (Auth::guard('admin')->user()->role == 'super admin')
                                <div class="tab-pane" id="ubahProfile">
                                    <form action="{{ route('Update Data Nakes', [$dataAdmin->nakes->id]) }}" method="POST" class="form-horizontal">
                                        @csrf
                                        <div class="form-floating mb-3">
                                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="floatingInput" value="{{ old('nama', $dataAdmin->nakes->nama_nakes) }}" placeholder="Nama Lengkap Kader">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" id="floatingInput" value="{{ old('nik', $dataAdmin->nakes->nik) }}" placeholder="NIK Kader">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-floating mb-3">
                                                    <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" id="floatingInput" value="{{ old('tempat_lahir', $dataAdmin->nakes->tempat_lahir) }}" placeholder="Tempat Lahir Kader">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <div class="form-floating">
                                                        <input  type="text" name="tgl_lahir" autocomplete="off" class="form-control @error('tgl_lahir') is-invalid @enderror" value="{{ old('tgl_lahir', date('d-m-Y', strtotime($dataAdmin->nakes->tanggal_lahir))) }}" id="floatingInput" placeholder="Tanggal Lahir Kader" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask>
