        ...
        <div class="col-md-12 col-lg-8">
            <div class="card mb-3">
                <div class="row g-0">
                    ...
                    <div class="col-md-7">
                        <div class="card-body">
                            <h5 class="card-title fw-bold"><a href="{{ route('Detail Penyuluhan') }}" class="text-decoration-none page-scroll">Judul Penyuluhan</a></h5>
                            <p class="card-text small"><span class="text-muted">Oleh Admin A</span> | <span>Pada 15-Mar-20</span></p>
                            <p class="card-text">Deskripsi singkat dari Penyuluhan yang ditampilkan nantinya pada list penyuluhan</p>
            ...
            <div class="card px-3">
                ...
                <div class="mb-3 border-0 border-bottom">
                    <div class="row g-0 py-2">
                        ...
                        <div class="col-7">
                            <div class="card-body">
                                <h6 class="card-title fw-bold"><a href="" class="text-decoration-none page-scroll">Judul Penyuluhan Lainya</a></h6>
                                <p class="card-text small">
                                <span class="text-muted"><i class="fas fa-comments"></i> 27</span>
                                <span class="fw-bold mx-2"> | </span>
                                <span><i class="fas fa-eye"></i> 150</span>
