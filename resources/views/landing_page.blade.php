    ...
    <div class="container d-none d-lg-block">
      <div class="row">
        <div class="col-12 text-center mb-4 mt-5">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">Smart POSYANDU<span class="text-primary">.</span> </a></h1>
          </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5 site-section border-bottom">
          ...
          <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
            <h2 class="text-black">Bersama Smart POSYANDU</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <p style="text-align: center;">Anda dapat melakukan pendaftaran online pada website resmi smart POSYANDU atau offline dengan mengunjungi posyandu terdekat di daerah anda</p>
