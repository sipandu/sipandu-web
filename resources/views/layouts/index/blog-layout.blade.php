        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <div class="blog-content">
                        <h4><a class="text-decoration-none" href="#">Judul Berita Keempat</a></h4>
                        <p>Lorem ipsum dolor sirtewt amertse consetetur sadipscing elitr, sedqw dinoumy eirmod tempor invidunt
                            sedrsu.</p>
                        <a class="read-more text-decoration-none" href="#">Baca selengkapnya <i class="lni lni-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <div class="blog-content">
                        <h4><a class="text-decoration-none" href="#">Judul Berita Kelima</a></h4>
                        <p>Lorem ipsum dolor sirtewt amertse consetetur sadipscing elitr, sedqw dinoumy eirmod tempor invidunt
                            sedrsu.</p>
                        <a class="read-more text-decoration-none" href="#">Baca selengkapnya <i class="lni lni-arrow-right"></i></a>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".6s">
                    ...
                    <div class="blog-content">
                        <h4><a class="text-decoration-none" href="#">Judul Berita Keenam</a></h4>
                        <p>Lorem ipsum dolor sirtewt amertse consetetur sadipscing elitr, sedqw dinoumy eirmod tempor invidunt
                            sedrsu.</p>
                        <a class="read-more text-decoration-none" href="#">Baca selengkapnya <i class="lni lni-arrow-right"></i></a>
                    </div>
