<footer class="footer pt-100 img-bg" style="background-image:url('/index-template/img/bg/footer-bg.jpg')">
    <div class="container">
        ...
        <div class="copyright-area">
            <p class="mb-0 text-center">Copyright &copy; {{ date('Y', strtotime(date('Y-m-d H:i:s'))) }}  <a class="text-decoration-none" href="https://uideck.com/" rel="nofollow">Posyandu 5.0</a></p>
        </div>
    </div>
</footer>